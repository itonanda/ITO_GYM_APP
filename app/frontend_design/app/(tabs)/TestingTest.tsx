...
export default function MemberDashboardAfterBookingScreen() {
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.dotContainer}>
          {classDataBookingClass.map((_, index) => (
            <View
              ...
              style={[
                styles.dot,
                activeIndexBookingClass === index && styles.activeDot,
              ]}
            />
          ))}
        </View>*/}
        ...
        <View style={styles.menuContainer}>
          ...
          <TouchableOpacity style={styles.menuItem} activeOpacity={0.7} onPress={() => router.replace('/(tabs)/MemberUpdatedClassSchedule')}>
            <View style={styles.menuIcon}>
