...
export default function CheckPaymentMethodScreen() {
      ...
      [
        {
          ...
          onPress: () => {
            ...
            if (selectedMethod?.title === "QRIS") {
              router.push("/(tabs)/CheckOutQR");
            } else if (selectedMethod?.title === "Gopay") {
              router.push("/(tabs)/CheckOutGopay");
            } else if (selectedMethod?.title === "BCA Transfer") {
              router.push("/(tabs)/CheckOutBCA");
            }
          },
        },
      ]
  ...
  return (
    <View style={styles.container}>
      ...
      <LinearGradient
        ...
        style={styles.header}
      >
        <TouchableOpacity style={styles.backButton} onPress={() => router.replace('/(tabs)/CheckOut')}>
