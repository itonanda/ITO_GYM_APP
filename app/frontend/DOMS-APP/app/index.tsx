import { View, Text , Image, ImageBackground, StyleSheet, Button, ActivityIndicator,  } from 'react-native';
...
export default function IndexScreen() {
  ...
  useEffect(() => {
    // Pantau status sesi langsung di halaman ini agar UI langsung berubah saat login/logout
